...
# 2. Get your AWS account ID and region (PowerShell syntax)
...
Write-Host "Image pushed to: $AWS_ACCOUNT_ID.dkr.ecr.$AWS_REGION.amazonaws.com/rickarkoportfolio:latest"